...
<footer
  class="flex flex-col items-center bg-black text-center text-white " style="margin-top: -26px;">
  <div class="container px-6 pt-6">
      ...
      <form action="">
        <div
          ...
          <div class="md:mb-6 md:ml-auto">
            <p class="">
              <strong>Hãy giữ liên lạc với chúng tôi </strong>
            </p>
          </div>
    ...
    <div class=" my-36">
      <p >
           Mercedes-Benz thì đẳng cấp cmnr, mua về mà chở gái nhún nhảy hồ Tây nhé !!! 
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-5 ">
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Mua xe</h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!" class="text-white">Xe đã qua sử dụng </a>
          </li>
          <li>
            <a href="#!" class="text-white">Xe mới </a>
          </li>
          <li>
            <a href="#!" class="text-white"> Chọn cấu hình xe </a>
          </li>
          <li>
            <a href="#!" class="text-white">Bảng giá & brochure </a>
          </li>
        </ul>
      </div>

      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Tư vấn mua xe </h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!" class="text-white">Yêu cầu tư vấn</a>
          </li>
          <li>
            <a href="#!" class="text-white">Đăng kí lái thử</a>
          </li>
          <li>
            <a href="#!" class="text-white">Tìm nhà phân phối gần nhất</a>
          </li>
        </ul>
      </div>

      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Dịch vụ </h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!" class="text-white">Đặt hẹn dịch vụ </a>
          </li>
          <li>
            <a href="#!" class="text-white">Ưu đãi đặc biệt </a>
          </li>
          <li>
            <a href="#!" class="text-white">Hướng dẫn sử dụng dành cho chủ xe  </a>
          </li>
          <li>
            <a href="#!" class="text-white">Triệu hồi xe </a>
          </li>
        </ul>
      </div>

      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Các dòng xe </h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!" class="text-white">SUV </a>
          </li>
          <li>
            <a href="#!" class="text-white">Sedan </a>
          </li>
          <li>
            <a href="#!" class="text-white">Mercedes-AMG </a>
          </li>
          <li>
            <a href="#!" class="text-white">Mercedes-Maybach </a>
          </li>
        </ul>
      </div>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Giới thiệu </h5>
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            <a href="#!" class="text-white">Câu chuyện của chúng tôi </a>
          </li>
          <li>
            <a href="#!" class="text-white">Phát triển bền vững & tương lai  </a>
          </li>
          <li>
            <a href="#!" class="text-white">Tin tức & sự kiện </a>
          </li>
        </ul>
      </div>
    </div>
